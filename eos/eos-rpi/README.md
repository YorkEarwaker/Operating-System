...
| Id   | OS Name                 | Micro SD Card | Architecture  | SSH client alias  | SSH Ubuntu One | Use Case           | ISO                                                    |
| :--- | :---------              | :----------:  | :----------:  | :---------------: | :------------: | :-------           | :-----------                                           |
| 01   | RPi OS Trixie Lite      |    64 GB      |  ARM 64 bit   | yes               | n\a            | AGW PMS test env   | 2026-06-18-raspios-trixie-arm64-lite.img.xz            |
